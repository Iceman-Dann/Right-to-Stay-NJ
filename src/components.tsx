  ...
  return (
    <div className={`min-h-screen bg-paper text-ink font-body transition-all duration-200 ${fontSize === 'large' ? 'accessibility-large-text' : ''}`}>
      ...
      <footer className="border-t border-rule hidden md:block">
        <div className="shell py-8 text-sm leading-6">
      ...
      <div className={`bottom-sheet-drawer fixed bottom-0 left-0 right-0 z-50 bg-paper border-t border-rule rounded-t-xl p-6 shadow-2xl transition-transform duration-300 transform md:hidden ${drawerOpen ? 'translate-y-0' : 'translate-y-full'}`}>
        ...
        <div className="mt-8 border-t border-rule pt-6 space-y-5">
          ...
          <div className="pt-2">
            <a href="tel:18885765529" className="flex items-center justify-center gap-2 py-3 bg-margin text-paper rounded-lg font-bold text-sm active:scale-98 transition shadow-sm">
